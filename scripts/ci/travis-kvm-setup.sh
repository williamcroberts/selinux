...
CHECK_URL="https://getfedora.org/static/checksums/Fedora-Cloud-$MAJOR_VERSION-$MINOR_VERSION-x86_64-CHECKSUM"
...
image_path="$HOME/$(basename -s .xz $IMAGE_BASE)"
echo "Print using image for KVM: $image_path"
